...
## 4. What was built on that diagnosis (4.120.0, 2026-09-20; measurement pending)
...
- Cell g1: control vs the three levers on 35 TB4.0 tasks (29 ever-passed ∪ the 13-task pool), 3-hour budgets, two Vast VMs. **RESULT: pending.**
...
_Pending: the g1 result decides whether the next spend is a full-66 confirmation of the gap-hold/spec-test pair (≈ $100) or a pivot to the
