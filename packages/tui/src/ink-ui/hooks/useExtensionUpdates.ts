...
import { debugLogger, type GeminiCLIExtension } from '../core-stubs.js';
import { getErrorMessage } from '@nexus-cortex/cli/dist/utils/errors.js';
import {
...
import {
  ...
  updateExtension,
} from '@nexus-cortex/cli/dist/config/extensions/update.js';
import { type ExtensionUpdateInfo } from '@nexus-cortex/cli/dist/config/extension.js';
import { checkExhaustive } from '@nexus-cortex/cli/dist/utils/checks.js';
