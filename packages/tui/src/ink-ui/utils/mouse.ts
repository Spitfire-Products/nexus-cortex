...
import { enableMouseEvents, disableMouseEvents } from '../core-stubs.js';
import {
  SGR_MOUSE_REGEX,
  X11_MOUSE_REGEX,
  SGR_EVENT_PREFIX,
...
export function parseX11MouseEvent(
  ...
  const b = matchData.charCodeAt(0) - 32;
  const col = matchData.charCodeAt(1) - 32;
  const row = matchData.charCodeAt(2) - 32;
