...
import type { KeyBinding, KeyBindingConfig } from '@nexus-cortex/cli/dist/config/keyBindings.js';
import { Command, defaultKeyBindings } from '@nexus-cortex/cli/dist/config/keyBindings.js';
