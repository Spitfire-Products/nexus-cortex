...
// System message info for the manager view
...
export type HistoryItemSystemMessageManager = HistoryItemBase & {
  type: 'system_message_manager';
...
export type HistoryItemWithoutId =
  ...
  | HistoryItemChatList
  | HistoryItemSystemMessageManager;
...
export enum MessageType {
  ...
  CHAT_LIST = 'chat_list',
  SYSTEM_MESSAGE_MANAGER = 'system_message_manager',
}
