...
import type {
  ...
  LoadedSettings,
  Settings,
} from '@nexus-cortex/cli/dist/config/settings.js';
import { SettingScope } from '@nexus-cortex/cli/dist/config/settings.js';
import {
  getScopeItems,
  getScopeMessageForSetting,
} from '@nexus-cortex/cli/dist/utils/dialogScopeUtils.js';
...
import {
  ...
  getNestedValue,
  getEffectiveValue,
} from '@nexus-cortex/cli/dist/utils/settingsUtils.js';
...
import {
  type SettingsValue,
  TOGGLE_TYPES,
} from '@nexus-cortex/cli/dist/config/settingsSchema.js';
