...
export function mergeWithDefaults(env: EnvironmentVariables): Required<EnvironmentVariables> {
  ...
  return {
    ...
    CORTEX_COMPACTION_RESUME: env.CORTEX_COMPACTION_RESUME || process.env.CORTEX_COMPACTION_RESUME || D.CORTEX_COMPACTION_RESUME,
    CORTEX_COMPACTION_CHECKPOINT_PCT: env.CORTEX_COMPACTION_CHECKPOINT_PCT || process.env.CORTEX_COMPACTION_CHECKPOINT_PCT || D.CORTEX_COMPACTION_CHECKPOINT_PCT,
    CORTEX_COMPACTION_THRESHOLD_TOKENS: env.CORTEX_COMPACTION_THRESHOLD_TOKENS || process.env.CORTEX_COMPACTION_THRESHOLD_TOKENS || D.CORTEX_COMPACTION_THRESHOLD_TOKENS,
    CORTEX_COMPACTION_HANDOFF_QA: env.CORTEX_COMPACTION_HANDOFF_QA || process.env.CORTEX_COMPACTION_HANDOFF_QA || D.CORTEX_COMPACTION_HANDOFF_QA,
    CORTEX_COMPACTION_HANDOFF_QA_MAX_QUESTIONS: env.CORTEX_COMPACTION_HANDOFF_QA_MAX_QUESTIONS || process.env.CORTEX_COMPACTION_HANDOFF_QA_MAX_QUESTIONS || D.CORTEX_COMPACTION_HANDOFF_QA_MAX_QUESTIONS,
    CORTEX_STATE_DIR: env.CORTEX_STATE_DIR || process.env.CORTEX_STATE_DIR || D.CORTEX_STATE_DIR,
    CORTEX_COMPACTION_CHECKPOINT_STEP: env.CORTEX_COMPACTION_CHECKPOINT_STEP || process.env.CORTEX_COMPACTION_CHECKPOINT_STEP || D.CORTEX_COMPACTION_CHECKPOINT_STEP,
    CORTEX_DELEGATION_HINT: env.CORTEX_DELEGATION_HINT || process.env.CORTEX_DELEGATION_HINT || D.CORTEX_DELEGATION_HINT,
    CORTEX_TURN_CONTRACT: env.CORTEX_TURN_CONTRACT || process.env.CORTEX_TURN_CONTRACT || D.CORTEX_TURN_CONTRACT,
    CORTEX_SUBAGENT_TIMEOUT_MS: env.CORTEX_SUBAGENT_TIMEOUT_MS || process.env.CORTEX_SUBAGENT_TIMEOUT_MS || D.CORTEX_SUBAGENT_TIMEOUT_MS,
    CORTEX_SUBAGENT_TIMEOUT_MAX_MS: env.CORTEX_SUBAGENT_TIMEOUT_MAX_MS || process.env.CORTEX_SUBAGENT_TIMEOUT_MAX_MS || D.CORTEX_SUBAGENT_TIMEOUT_MAX_MS,
    CORTEX_OUTER_TOOL_TIMEOUT_MS: env.CORTEX_OUTER_TOOL_TIMEOUT_MS || process.env.CORTEX_OUTER_TOOL_TIMEOUT_MS || D.CORTEX_OUTER_TOOL_TIMEOUT_MS,
    CORTEX_API_NETWORK_RETRY_MS: env.CORTEX_API_NETWORK_RETRY_MS || process.env.CORTEX_API_NETWORK_RETRY_MS || D.CORTEX_API_NETWORK_RETRY_MS,
    CORTEX_BUDGET_VISIBILITY: env.CORTEX_BUDGET_VISIBILITY || process.env.CORTEX_BUDGET_VISIBILITY || D.CORTEX_BUDGET_VISIBILITY,
    CORTEX_BUDGET_CONTINUE_MIN_REMAINING: env.CORTEX_BUDGET_CONTINUE_MIN_REMAINING || process.env.CORTEX_BUDGET_CONTINUE_MIN_REMAINING || D.CORTEX_BUDGET_CONTINUE_MIN_REMAINING,
    CORTEX_REASONING_EXHAUST_BACKOFF: env.CORTEX_REASONING_EXHAUST_BACKOFF || process.env.CORTEX_REASONING_EXHAUST_BACKOFF || D.CORTEX_REASONING_EXHAUST_BACKOFF,
    CORTEX_REASONING_EXHAUST_BACKOFF_TURNS: env.CORTEX_REASONING_EXHAUST_BACKOFF_TURNS || process.env.CORTEX_REASONING_EXHAUST_BACKOFF_TURNS || D.CORTEX_REASONING_EXHAUST_BACKOFF_TURNS,
    CORTEX_BUDGET_CONTINUE_MAX_NUDGES: env.CORTEX_BUDGET_CONTINUE_MAX_NUDGES || process.env.CORTEX_BUDGET_CONTINUE_MAX_NUDGES || D.CORTEX_BUDGET_CONTINUE_MAX_NUDGES,
    CORTEX_BASH_OOM_PRIORITY: env.CORTEX_BASH_OOM_PRIORITY || process.env.CORTEX_BASH_OOM_PRIORITY || D.CORTEX_BASH_OOM_PRIORITY,
    CORTEX_MENTOR_CONSULT_BUDGET_TOKENS: env.CORTEX_MENTOR_CONSULT_BUDGET_TOKENS || process.env.CORTEX_MENTOR_CONSULT_BUDGET_TOKENS || D.CORTEX_MENTOR_CONSULT_BUDGET_TOKENS,
    CORTEX_ENDTURN_RESOLVER_MAX_REJECTS_BUDGETED: env.CORTEX_ENDTURN_RESOLVER_MAX_REJECTS_BUDGETED || process.env.CORTEX_ENDTURN_RESOLVER_MAX_REJECTS_BUDGETED || D.CORTEX_ENDTURN_RESOLVER_MAX_REJECTS_BUDGETED,
    CORTEX_JUDGE_SEMANTIC: env.CORTEX_JUDGE_SEMANTIC || process.env.CORTEX_JUDGE_SEMANTIC || D.CORTEX_JUDGE_SEMANTIC,
    CORTEX_JUDGE_VETO: env.CORTEX_JUDGE_VETO || process.env.CORTEX_JUDGE_VETO || D.CORTEX_JUDGE_VETO,
    CORTEX_FINISH_CONFIRM: env.CORTEX_FINISH_CONFIRM || process.env.CORTEX_FINISH_CONFIRM || D.CORTEX_FINISH_CONFIRM,
    CORTEX_FINISH_CONFIRM_MIN_REMAINING: env.CORTEX_FINISH_CONFIRM_MIN_REMAINING || process.env.CORTEX_FINISH_CONFIRM_MIN_REMAINING || D.CORTEX_FINISH_CONFIRM_MIN_REMAINING,
    CORTEX_FINISH_CONFIRM_MAX: env.CORTEX_FINISH_CONFIRM_MAX || process.env.CORTEX_FINISH_CONFIRM_MAX || D.CORTEX_FINISH_CONFIRM_MAX,
    CORTEX_MEETS_CONFIRM: env.CORTEX_MEETS_CONFIRM || process.env.CORTEX_MEETS_CONFIRM || D.CORTEX_MEETS_CONFIRM,
    CORTEX_MEETS_CONFIRM_MIN_REMAINING: env.CORTEX_MEETS_CONFIRM_MIN_REMAINING || process.env.CORTEX_MEETS_CONFIRM_MIN_REMAINING || D.CORTEX_MEETS_CONFIRM_MIN_REMAINING,
    CORTEX_JUDGE_TOOL_ROUNDS: env.CORTEX_JUDGE_TOOL_ROUNDS || process.env.CORTEX_JUDGE_TOOL_ROUNDS || D.CORTEX_JUDGE_TOOL_ROUNDS,
    CORTEX_JUDGE_TOOL_ROUND_BUDGET_MS: env.CORTEX_JUDGE_TOOL_ROUND_BUDGET_MS || process.env.CORTEX_JUDGE_TOOL_ROUND_BUDGET_MS || D.CORTEX_JUDGE_TOOL_ROUND_BUDGET_MS,
    CORTEX_JUDGE_TOOL_AUTOLOOP: env.CORTEX_JUDGE_TOOL_AUTOLOOP || process.env.CORTEX_JUDGE_TOOL_AUTOLOOP || D.CORTEX_JUDGE_TOOL_AUTOLOOP,
    CORTEX_JUDGE_GAP_HOLD: env.CORTEX_JUDGE_GAP_HOLD || process.env.CORTEX_JUDGE_GAP_HOLD || D.CORTEX_JUDGE_GAP_HOLD,
    CORTEX_JUDGE_GAP_HOLD_JEV: env.CORTEX_JUDGE_GAP_HOLD_JEV || process.env.CORTEX_JUDGE_GAP_HOLD_JEV || D.CORTEX_JUDGE_GAP_HOLD_JEV,
    CORTEX_JUDGE_GAP_HOLD_JEV_MIN: env.CORTEX_JUDGE_GAP_HOLD_JEV_MIN || process.env.CORTEX_JUDGE_GAP_HOLD_JEV_MIN || D.CORTEX_JUDGE_GAP_HOLD_JEV_MIN,
    CORTEX_JUDGE_SPEC_TESTS: env.CORTEX_JUDGE_SPEC_TESTS || process.env.CORTEX_JUDGE_SPEC_TESTS || D.CORTEX_JUDGE_SPEC_TESTS,
    CORTEX_JUDGE_SPEC_TESTS_MAX: env.CORTEX_JUDGE_SPEC_TESTS_MAX || process.env.CORTEX_JUDGE_SPEC_TESTS_MAX || D.CORTEX_JUDGE_SPEC_TESTS_MAX,
    CORTEX_JUDGE_VETO_MIN_REMAINING: env.CORTEX_JUDGE_VETO_MIN_REMAINING || process.env.CORTEX_JUDGE_VETO_MIN_REMAINING || D.CORTEX_JUDGE_VETO_MIN_REMAINING,
    CORTEX_JUDGE_GAP_HOLD_MIN_INTERVAL_MS: env.CORTEX_JUDGE_GAP_HOLD_MIN_INTERVAL_MS || process.env.CORTEX_JUDGE_GAP_HOLD_MIN_INTERVAL_MS || D.CORTEX_JUDGE_GAP_HOLD_MIN_INTERVAL_MS,
    CORTEX_JUDGE_GAP_HOLD_PLAN_MAX_SIMILARITY: env.CORTEX_JUDGE_GAP_HOLD_PLAN_MAX_SIMILARITY || process.env.CORTEX_JUDGE_GAP_HOLD_PLAN_MAX_SIMILARITY || D.CORTEX_JUDGE_GAP_HOLD_PLAN_MAX_SIMILARITY,
    CORTEX_JUDGE_SPEC_REPEAT_MAX: env.CORTEX_JUDGE_SPEC_REPEAT_MAX || process.env.CORTEX_JUDGE_SPEC_REPEAT_MAX || D.CORTEX_JUDGE_SPEC_REPEAT_MAX,
    CORTEX_JUDGE_SPEC_TESTS_AT: env.CORTEX_JUDGE_SPEC_TESTS_AT || process.env.CORTEX_JUDGE_SPEC_TESTS_AT || D.CORTEX_JUDGE_SPEC_TESTS_AT,
    CORTEX_JUDGE_REQ_LEDGER: env.CORTEX_JUDGE_REQ_LEDGER || process.env.CORTEX_JUDGE_REQ_LEDGER || D.CORTEX_JUDGE_REQ_LEDGER,
    CORTEX_JUDGE_REQ_LEDGER_MAX: env.CORTEX_JUDGE_REQ_LEDGER_MAX || process.env.CORTEX_JUDGE_REQ_LEDGER_MAX || D.CORTEX_JUDGE_REQ_LEDGER_MAX,
    CORTEX_JUDGE_REQ_LEDGER_HOLD_MAX: env.CORTEX_JUDGE_REQ_LEDGER_HOLD_MAX || process.env.CORTEX_JUDGE_REQ_LEDGER_HOLD_MAX || D.CORTEX_JUDGE_REQ_LEDGER_HOLD_MAX,
    CORTEX_JUDGE_REQ_LEDGER_JEV: env.CORTEX_JUDGE_REQ_LEDGER_JEV || process.env.CORTEX_JUDGE_REQ_LEDGER_JEV || D.CORTEX_JUDGE_REQ_LEDGER_JEV,
    CORTEX_JUDGE_REQ_LEDGER_JEV_MIN: env.CORTEX_JUDGE_REQ_LEDGER_JEV_MIN || process.env.CORTEX_JUDGE_REQ_LEDGER_JEV_MIN || D.CORTEX_JUDGE_REQ_LEDGER_JEV_MIN,
    CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO: env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO || process.env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO || D.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO,
    CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MAX: env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MAX || process.env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MAX || D.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MAX,
    CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MIN_REMAINING: env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MIN_REMAINING || process.env.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MIN_REMAINING || D.CORTEX_JUDGE_REQ_LEDGER_FAIL_VETO_MIN_REMAINING,
    CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV: env.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV || process.env.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV || D.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV,
    CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV_MIN: env.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV_MIN || process.env.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV_MIN || D.CORTEX_JUDGE_REQ_LEDGER_FAIL_JEV_MIN,
    CORTEX_JUDGE_INDEPENDENT_DERIVATION: env.CORTEX_JUDGE_INDEPENDENT_DERIVATION || process.env.CORTEX_JUDGE_INDEPENDENT_DERIVATION || D.CORTEX_JUDGE_INDEPENDENT_DERIVATION,
    CORTEX_JUDGE_INDEPENDENT_DERIVATION_TOL: env.CORTEX_JUDGE_INDEPENDENT_DERIVATION_TOL || process.env.CORTEX_JUDGE_INDEPENDENT_DERIVATION_TOL || D.CORTEX_JUDGE_INDEPENDENT_DERIVATION_TOL,
    CORTEX_FRAME: env.CORTEX_FRAME || process.env.CORTEX_FRAME || D.CORTEX_FRAME,
    CORTEX_FRAME_CHOOSER: env.CORTEX_FRAME_CHOOSER || process.env.CORTEX_FRAME_CHOOSER || D.CORTEX_FRAME_CHOOSER,
    CORTEX_FRAME_CANDIDATES: env.CORTEX_FRAME_CANDIDATES || process.env.CORTEX_FRAME_CANDIDATES || D.CORTEX_FRAME_CANDIDATES,
    CORTEX_FRAME_WAIT_CAP_S: env.CORTEX_FRAME_WAIT_CAP_S || process.env.CORTEX_FRAME_WAIT_CAP_S || D.CORTEX_FRAME_WAIT_CAP_S,
    CORTEX_FRAME_SCREEN_LINES: env.CORTEX_FRAME_SCREEN_LINES || process.env.CORTEX_FRAME_SCREEN_LINES || D.CORTEX_FRAME_SCREEN_LINES,
    CORTEX_FRAME_KEY_GUARD: env.CORTEX_FRAME_KEY_GUARD || process.env.CORTEX_FRAME_KEY_GUARD || D.CORTEX_FRAME_KEY_GUARD,
    CORTEX_FRAME_MIN_CANDIDATES: env.CORTEX_FRAME_MIN_CANDIDATES || process.env.CORTEX_FRAME_MIN_CANDIDATES || D.CORTEX_FRAME_MIN_CANDIDATES,
    CORTEX_FRAME_AUTHOR: env.CORTEX_FRAME_AUTHOR || process.env.CORTEX_FRAME_AUTHOR || D.CORTEX_FRAME_AUTHOR,
    CORTEX_FRAME_AUTHOR_MODEL: env.CORTEX_FRAME_AUTHOR_MODEL || process.env.CORTEX_FRAME_AUTHOR_MODEL || D.CORTEX_FRAME_AUTHOR_MODEL,
    CORTEX_FRAME_AUTHOR_WHEN: env.CORTEX_FRAME_AUTHOR_WHEN || process.env.CORTEX_FRAME_AUTHOR_WHEN || D.CORTEX_FRAME_AUTHOR_WHEN,
    CORTEX_FRAME_CONTRACT_EXTRA: env.CORTEX_FRAME_CONTRACT_EXTRA || process.env.CORTEX_FRAME_CONTRACT_EXTRA || D.CORTEX_FRAME_CONTRACT_EXTRA,
    CORTEX_TURN_CONTRACT_ENFORCE: env.CORTEX_TURN_CONTRACT_ENFORCE || process.env.CORTEX_TURN_CONTRACT_ENFORCE || D.CORTEX_TURN_CONTRACT_ENFORCE,
    CORTEX_TURN_CONTRACT_ENFORCE_MAX: env.CORTEX_TURN_CONTRACT_ENFORCE_MAX || process.env.CORTEX_TURN_CONTRACT_ENFORCE_MAX || D.CORTEX_TURN_CONTRACT_ENFORCE_MAX,
    CORTEX_ACTION_PLAN_FIELDS: env.CORTEX_ACTION_PLAN_FIELDS || process.env.CORTEX_ACTION_PLAN_FIELDS || D.CORTEX_ACTION_PLAN_FIELDS,
    CORTEX_JUDGE_EVIDENCE_MAX_VETOES: env.CORTEX_JUDGE_EVIDENCE_MAX_VETOES || process.env.CORTEX_JUDGE_EVIDENCE_MAX_VETOES || D.CORTEX_JUDGE_EVIDENCE_MAX_VETOES,
    CORTEX_JUDGE_PROGRESS_MIN_CALLS: env.CORTEX_JUDGE_PROGRESS_MIN_CALLS || process.env.CORTEX_JUDGE_PROGRESS_MIN_CALLS || D.CORTEX_JUDGE_PROGRESS_MIN_CALLS,
    CORTEX_JUDGE_ESCALATE_REASONING: env.CORTEX_JUDGE_ESCALATE_REASONING || process.env.CORTEX_JUDGE_ESCALATE_REASONING || D.CORTEX_JUDGE_ESCALATE_REASONING,
    CORTEX_HERDR_REPORTING: env.CORTEX_HERDR_REPORTING || process.env.CORTEX_HERDR_REPORTING || D.CORTEX_HERDR_REPORTING,
    CORTEX_HERDR_AGENT_NAME: env.CORTEX_HERDR_AGENT_NAME || process.env.CORTEX_HERDR_AGENT_NAME || D.CORTEX_HERDR_AGENT_NAME,
    CORTEX_TERMINAL_BACKEND: env.CORTEX_TERMINAL_BACKEND || process.env.CORTEX_TERMINAL_BACKEND || D.CORTEX_TERMINAL_BACKEND,
    CORTEX_TMUX_AUTO_INSTALL: env.CORTEX_TMUX_AUTO_INSTALL || process.env.CORTEX_TMUX_AUTO_INSTALL || D.CORTEX_TMUX_AUTO_INSTALL,
    CORTEX_TMUX_STATIC_URL: env.CORTEX_TMUX_STATIC_URL || process.env.CORTEX_TMUX_STATIC_URL || D.CORTEX_TMUX_STATIC_URL,
    CORTEX_TMUX_HISTORY_LIMIT: env.CORTEX_TMUX_HISTORY_LIMIT || process.env.CORTEX_TMUX_HISTORY_LIMIT || D.CORTEX_TMUX_HISTORY_LIMIT,
    CORTEX_TMUX_PANE_SIZE: env.CORTEX_TMUX_PANE_SIZE || process.env.CORTEX_TMUX_PANE_SIZE || D.CORTEX_TMUX_PANE_SIZE,
    CORTEX_SUBAGENT_RUNTIME: env.CORTEX_SUBAGENT_RUNTIME || process.env.CORTEX_SUBAGENT_RUNTIME || D.CORTEX_SUBAGENT_RUNTIME,
    CORTEX_HERDR_KEEP_DELEGATE_PANES: env.CORTEX_HERDR_KEEP_DELEGATE_PANES || process.env.CORTEX_HERDR_KEEP_DELEGATE_PANES || D.CORTEX_HERDR_KEEP_DELEGATE_PANES,
