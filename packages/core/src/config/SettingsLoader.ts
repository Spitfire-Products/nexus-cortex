...
export function mergeWithDefaults(env: EnvironmentVariables): Required<EnvironmentVariables> {
  ...
  return {
    ...
    CANON_AUTO_SYNC: env.CANON_AUTO_SYNC || process.env.CANON_AUTO_SYNC || DEFAULT_SETTINGS.CANON_AUTO_SYNC,
    CANON_AUTO_SYNC_DEBOUNCE_MS: env.CANON_AUTO_SYNC_DEBOUNCE_MS || process.env.CANON_AUTO_SYNC_DEBOUNCE_MS || DEFAULT_SETTINGS.CANON_AUTO_SYNC_DEBOUNCE_MS,
    CANON_STORE: env.CANON_STORE || process.env.CANON_STORE || DEFAULT_SETTINGS.CANON_STORE,
    CANON_REPO: env.CANON_REPO || process.env.CANON_REPO || DEFAULT_SETTINGS.CANON_REPO,

    // Context Management
    THINKING_AS_TEXT_FALLBACK: env.THINKING_AS_TEXT_FALLBACK || process.env.THINKING_AS_TEXT_FALLBACK || DEFAULT_SETTINGS.THINKING_AS_TEXT_FALLBACK,
    ...
    AUTORESEARCH_AGENTS: env.AUTORESEARCH_AGENTS || DEFAULT_SETTINGS.AUTORESEARCH_AGENTS,
    SYSTEM_MESSAGE_DOC_MAX_BYTES: env.SYSTEM_MESSAGE_DOC_MAX_BYTES || DEFAULT_SETTINGS.SYSTEM_MESSAGE_DOC_MAX_BYTES,
    MEMORY_ARCHIVE_MAX_BYTES: env.MEMORY_ARCHIVE_MAX_BYTES || DEFAULT_SETTINGS.MEMORY_ARCHIVE_MAX_BYTES,
    ...
    ENABLE_WEBTOOLS: env.ENABLE_WEBTOOLS || process.env.ENABLE_WEBTOOLS || DEFAULT_SETTINGS.ENABLE_WEBTOOLS,
    VISION_HELPER_MODEL: env.VISION_HELPER_MODEL || process.env.VISION_HELPER_MODEL || DEFAULT_SETTINGS.VISION_HELPER_MODEL,
    TOOL_TIMEOUT_MODE: env.TOOL_TIMEOUT_MODE || process.env.TOOL_TIMEOUT_MODE || DEFAULT_SETTINGS.TOOL_TIMEOUT_MODE,
    VISION_HANDOFF_MAX: env.VISION_HANDOFF_MAX || process.env.VISION_HANDOFF_MAX || DEFAULT_SETTINGS.VISION_HANDOFF_MAX,
    CORTEX_SLICE_NUDGE: env.CORTEX_SLICE_NUDGE || process.env.CORTEX_SLICE_NUDGE || DEFAULT_SETTINGS.CORTEX_SLICE_NUDGE,
    ...
    CORTEX_TOOL_PROFILE: env.CORTEX_TOOL_PROFILE || process.env.CORTEX_TOOL_PROFILE || DEFAULT_SETTINGS.CORTEX_TOOL_PROFILE,
