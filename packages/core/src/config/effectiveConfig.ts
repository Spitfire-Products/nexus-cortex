...
const GROUPS: Array<{ group: string; levers: LeverSpec[] }> = [
  {
    ...
    levers: [
      ...
      { key: 'CORTEX_ENDTURN_TIER', what: 'EndTurn discovery tier: standard = deferred behind SearchTools (default) | essential = in the turn-1 tool set. 4.107.2 lever for the cell-n-r6 2×2', codeDefault: 'standard', kind: 'value' },
