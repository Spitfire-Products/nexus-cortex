...
const GROUPS: Array<{ group: string; levers: LeverSpec[] }> = [
  ...
  },
  {
    ...
    levers: [
      ...
      { key: 'CORTEX_TURN_CONTRACT_ENFORCE_MAX', what: 'Format rejections per turn before the batch executes as-is (HB-TURN-CONTRACT-ENFORCE)', codeDefault: '2', kind: 'value' },
