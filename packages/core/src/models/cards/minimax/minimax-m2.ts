 ...
 * MiniMax's flagship M2 model with 1M token context
 *
 * Best for: Chinese language, long context, multimodal tasks
...
export const minimaxM2: ModelConfig = createMiniMaxModelConfig({
  id: 'MiniMax-M2',
