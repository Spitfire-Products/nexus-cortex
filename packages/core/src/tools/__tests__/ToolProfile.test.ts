...
describe('VISION_HELPER_MODEL', () => {
  ...
  it('defaults to deepseek-flash (V4.1, multimodal; vision-exp retired 2026-09-10)', () => { delete process.env.VISION_HELPER_MODEL; expect(resolveVisionHelperModel()).toBe('deepseek-flash'); });
