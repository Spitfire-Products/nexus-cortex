...
// Run this with: node demo-themes.js
// Install chalk first: npm install chalk
...
console.log(border('│') + chalk.cyan.bold(' Nexus Cortex') + ' '.repeat(29) + chalk.dim('[Ctrl+C to exit]') + ' ' + border('│'));
...
console.log(syn.comment('// Nexus Cortex Example'));
console.log(syn.keyword('const') + ' ' + syn.variable('client') + ' = ' + syn.keyword('new') + ' ' + syn.function('CortexClient') + '({');
...
console.log(chalk.gray('   Run with: ') + chalk.yellow('node demo-themes.js'));
