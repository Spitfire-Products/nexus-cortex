...
- **An embeddable engine, not a closed app.** The orchestrator, adapters, <!--AUTO-COUNT:tools-->52<!--/AUTO-COUNT--> built-in tools, and middleware are a clean TypeScript library you build on.
